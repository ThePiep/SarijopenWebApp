...
export const KPCard = ({ ...props }: Props) => {
  ...
  return <Card {...props} titleIcon={false ? <FaBan /> : undefined}>
    <div className="grid grid-cols-12">

      {showExtra && (
        <div className="col-span-8 pl-4 mt-4">
      ...
      <div className={`stat place-items-center ${showExtra ? 'col-span-4' : 'col-span-12'}`}>
